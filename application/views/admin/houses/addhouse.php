    <div class="container top">
      ...
      <?php
      //form data
      $attributes = array('class' => 'form-horizontal', 'id' => 'add_house');
...
//      }
      ...
      echo form_open_multipart('admin/houses/addhouse', $attributes);
      ?>
        <fieldset>
...
<!--              <input type="text" id="house_rooms" name="house_rooms" value="<?php echo set_value('stock'); ?>">-->
              ...
              for($i=1;$i<=20;$i++){$arr_room[$i]=$i;}
                ...
                echo form_dropdown('house_rooms', $arr_room, set_value('house_rooms'), 'class="span2"'); ?>
          ...
          <div class="control-group">
           ...
           <div class="control-group">
            ...
            <div class="controls">
              <input type="text" class="txtdate" id="acquisition_date" name="acquisition_date" value="<?php echo set_value('sell_price'); ?>">
              <!--<span class="help-inline">OOps</span>-->
            </div>
          </div>
            <div class="control-group">
            ...
            <div class="controls">
              <input type="text"  class="txtdate" id="agreement_from" name="agreement_from" value="<?php echo set_value('sell_price'); ?>">
              <!--<span class="help-inline">OOps</span>-->
            </div>
          </div>
            <div class="control-group">
            ...
            <div class="controls">
              <input type="text"  class="txtdate" id="agreement_to" name="agreement_to" value="<?php echo set_value('sell_price'); ?>">
              <!--<span class="help-inline">OOps</span>-->
            </div>
          </div>
            <div class="control-group">
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    ...
                    <?php if (isset($document1) && $document1 != '' && file_exists("./assets/img/house/documents/$document1")) { ?>
                        <img src="<?php echo site_url(); ?>assets/images/institute_image/<?php echo $document1; ?>" style="position:absolute; padding-top: 10px;"  align="absmiddle" height="20px" width="20px" onerror="this.src='<?php echo site_url(); ?>assets/images/images.jpeg';" />
             ...
             <div class="control-group">
                ...
                <div class="controls">
                    ...
                    ?>
                    <a href="#" class="import_image">Browse Image</a>
                    <?php if (isset($document2) && $document2 != '' && file_exists("./assets/img/house/documents/$document2")) { ?>
                        <img src="<?php echo site_url(); ?>assets/images/institute_image/<?php echo $document2; ?>" style="position:absolute; padding-top: 10px;"  align="absmiddle" height="20px" width="20px" onerror="this.src='<?php echo site_url(); ?>assets/images/images.jpeg';" />
                        <?php } //echo form_error('uploadimage',"<span class='error'>","</span>");  ?>
                </div>
            </div>
             <div class="control-group">
                ...
                <div class="controls">
                    ...
                    ?>
                    <a href="#" class="import_image">Browse Image</a>
                    <?php if (isset($document3) && $document3 != '' && file_exists("./assets/img/house/documents/$document3")) { ?>
                        <img src="<?php echo site_url(); ?>assets/images/institute_image/<?php echo $document3; ?>" style="position:absolute; padding-top: 10px;"  align="absmiddle" height="20px" width="20px" onerror="this.src='<?php echo site_url(); ?>assets/images/images.jpeg';" />
                        <?php } //echo form_error('uploadimage',"<span class='error'>","</span>");  ?>
                </div>
            </div>
             <div class="control-group">
                ...
                <div class="controls">
                    ...
                    ?>
                    <a href="#" class="import_image">Browse Image</a>
                    <?php if (isset($document4) && $document4 != '' && file_exists("./assets/img/house/documents/$document4")) { ?>
                        <img src="<?php echo site_url(); ?>assets/images/institute_image/<?php echo $document4; ?>" style="position:absolute; padding-top: 10px;"  align="absmiddle" height="20px" width="20px" onerror="this.src='<?php echo site_url(); ?>assets/images/images.jpeg';" />
                        <?php } //echo form_error('uploadimage',"<span class='error'>","</span>");  ?>
                </div>
            </div>
