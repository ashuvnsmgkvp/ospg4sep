    <div class="container top">
      ...
      <div class="page-header users-header">
        <h2>
            Show Daily Expenses 
          <a  href="<?php echo site_url("admin").'/'.$this->uri->segment(2); ?>/adddailyexp" class="btn btn-success">Add a new</a>
        </h2>
      </div>
...
height: 26px;"');
          ...
          <table class="table table-striped table-bordered table-condensed">
            ...
            <tbody>
              ...
              {
                echo '<tr>';
                echo '<td>'.$row['dexp_id'].'</td>';
                echo '<td>'.$row['house_no'].'</td>';
                echo '<td>'.$head[$row['exp_type']][$row['head']].'</td>';
                echo '<td>'.$type[$row['exp_type']][$row['type']].'</td>';
                echo '<td>'.$row['payment_date'].'</td>';
                echo '<td>'.$row['paid_amount'].'</td>';
             
                echo '<td class="crud-actions">
                  <a href="'.site_url("admin").'/expense/updatedailyexp/'.$row['dexp_id'].'" class="btn btn-info">view & edit</a>  
                  <a href="'.site_url("admin").'/expense/deletedailyexp/'.$row['dexp_id'].'" class="btn btn-danger">delete</a>
                </td>';
                echo '</tr>';
              }
              ?>      
