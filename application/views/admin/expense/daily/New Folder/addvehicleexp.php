    <div class="container top">
      ...
      <ul class="breadcrumb">
        ...
        <li class="active">
          <a href="#">Add Goods Purchase</a>
        </li>
      </ul>
      
      <div class="page-header">
        <h2>
          Adding Goods Purchase
...
//      }
      ...
      ?>
        <fieldset>
            ...
            <label for="inputError" class="control-label">Vehicle Type </label>
            <div class="controls">
               <?php $options_manufacture = array(''=>'--Select--' ,'1'=>"Car",'2'=>"Bike",'3'=>'scooty');
          ...
          <div class="control-group">
            <label for="inputError" class="control-label">Vehicle No.</label>
            <div class="controls">
          ...
          <div class="control-group">
            ...
            <div class="controls">
                <?php $options_manufacture = array(''=>'--Select--' ,1=>'CNG', 
2=>'Petrol',
3=>'Diesal',
4=>'Service',
5=>'Challan' );
