    <div class="container top">
      ...
      echo form_open('admin/expense/addannualexp', $attributes);
      ...
      ?>
        <fieldset>
            ...
            <div class="controls">
                ...
                echo form_dropdown('exp_or_amc', $options_exp_amc, set_value('exp_or_amc'), 'class="span2" id="exp_or_amc"'); ?>
            </div>
          </div>
          <div class="control-group">
            ...
            <div class="controls">
				...
				echo form_dropdown('head', $options_head, set_value('head'), 'class="span2" id="head"');
...
<!--          <div class="control-group">
          ...
          <div class="control-group">
            ...
            <div class="controls"><input type="text" id="period_from" name="period_from" value="<?php echo set_value('period_from'); ?>" >
          ...
          <div class="control-group">
            ...
            <div class="controls">
                <input type="text" id="period_to" name="period_to" value="<?php echo set_value('period_to'); ?>" >    
              <!--<span class="help-inline">Cost Price</span>-->
            </div>
          </div>
            <div class="control-group">
            ...
            <div class="controls">
              <input type="text" id="paid_amount" name="paid_amount" value="<?php echo set_value('paid_amount'); ?>">
          ...
          <div class="control-group">
            ...
            <div class="controls">
              <input type="text" id="payment_date" name="payment_date" value="<?php echo set_value('payment_date'); ?>">
              <!--<span class="help-inline">OOps</span>-->
            </div>
          </div>
           <div class="control-group">
            ...
            <div class="controls">
              <input type="text" id="balance_amount" name="balance_amount" value="<?php echo set_value('balance_amount'); ?>">
              <!--<span class="help-inline">OOps</span>-->
            </div>
          </div>
