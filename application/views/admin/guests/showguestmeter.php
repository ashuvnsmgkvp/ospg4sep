    <div class="container top">
      ...
      <div class="page-header users-header">
        <h2>
          <?php echo ucfirst($this->uri->segment(2));?> 
            <a  href="<?php echo site_url("admin").'/'.$this->uri->segment(2); ?>/addguestmeter" class="btn btn-success" style="margin-left: 10px;">Add Meter Reading </a>
          <a  href="<?php echo site_url("admin").'/'.$this->uri->segment(2); ?>/addguest" class="btn btn-success">AddGuest</a>
        </h2>
      </div>
