...
//      }
      ...
      echo form_open('admin/commons/updateemp/'.$emp[0]['emp_id'], $attributes);
      //print_r($bank);
      ?>
        <fieldset>
          ...
          <div class="control-group">
            ...
            <div class="controls">
              <input type="text" id="emp_name" name="emp_name" value="<?php echo $emp[0]['emp_name']; ?>" >
          ...
          <div class="control-group">
            ...
            <div class="controls">
              <input type="text" id="emp_doj" name="emp_doj" value="<?php echo $emp[0]['emp_doj']; ?>" >
          ...
          <div class="control-group">
            ...
            <div class="controls">
              <input type="text" id="emp_dol" name="emp_dol" value="<?php echo $emp[0]['emp_dol']; ?>">
              <!--<span class="help-inline">Cost Price</span>-->
            </div>
          </div>
